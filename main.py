...
from config import LOG_FILE, BRUTE_DATA_CLEAN_FILE, EXCEL_FILE


from src import logging_file
from src import extracting_data_database, cleanning_brute_data, add_features
...
brute_data = extracting_data_database()
